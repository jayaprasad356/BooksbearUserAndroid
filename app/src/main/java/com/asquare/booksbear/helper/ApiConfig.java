...
public class ApiConfig extends Application {
    ...
    public static void GetPinCode(Activity activity) {
        try {
                    ...
                    if (result) {
                        try {
                            ...
                            if (!objectbject.getBoolean(Constant.ERROR)) {
                                new Session(activity).setData(Constant.GET_PINCODES_RESPONSE, objectbject.getJSONArray(Constant.DATA).toString());
                            }
