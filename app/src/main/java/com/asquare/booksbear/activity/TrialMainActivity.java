...
import com.asquare.booksbear.fragment.DrawerFragment;
...
public class TrialMainActivity extends AppCompatActivity implements OnMapReadyCallback, PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = TrialMainActivity.this;
    ...
    public void onPaymentSuccess(String razorpayPaymentID) {
        try {
            if (WalletTransactionFragment.payFromWallet) {
                ...
                new PaymentFragment().PlaceOrder(TrialMainActivity.this, PaymentFragment.paymentMethod, PaymentFragment.razorPayId, true, PaymentFragment.sendparams, Constant.SUCCESS);
                //new PaymentFragment().PlaceOrder(TrialMainActivity.this, PaymentFragment.paymentMethod, PaymentFragment.razorPayId, true, PaymentFragment.sendParams, Constant.SUCCESS);
            }
        } catch (Exception e) {
