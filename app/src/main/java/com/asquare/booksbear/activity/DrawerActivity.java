...
import com.asquare.booksbear.fragment.FaqFragment;
import com.asquare.booksbear.fragment.NotificationFragment;
import com.asquare.booksbear.fragment.ProfileFragment;
import com.asquare.booksbear.fragment.ReferEarnFragment;
import com.asquare.booksbear.fragment.TransactionFragment;
import com.asquare.booksbear.fragment.WalletTransactionFragment;
import com.asquare.booksbear.fragment.WebViewFragment;
...
import com.asquare.booksbear.helper.Utils;
        ...
        navigationView.setNavigationItemSelectedListener(menuItem -> {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.menu_sell:
                    ...
                    intent.putExtra("url",Constant.SELL);
                    intent.putExtra("title",getString(R.string.sell_books));
                    startActivity(intent);
                    break;
                case R.id.menu_rent:
                    intent = new Intent(getApplicationContext(),LoadUrlActivity.class);
                    intent.putExtra("url",Constant.RENT);
                    intent.putExtra("title",getString(R.string.rent_books));
                    startActivity(intent);
                    break;
                case R.id.menu_ebooks:
                    intent = new Intent(getApplicationContext(),LoadUrlActivity.class);
                    intent.putExtra("url",Constant.EBOOKS);
                    intent.putExtra("title",getString(R.string.e_books));
                    startActivity(intent);
                    break;
                case R.id.menu_donate:
                    intent = new Intent(getApplicationContext(),LoadUrlActivity.class);
                    intent.putExtra("url",Constant.DONATE);
                    intent.putExtra("title",getString(R.string.donate_books));
                    startActivity(intent);
                    break;
                case R.id.menu_request:
                    intent = new Intent(getApplicationContext(),LoadUrlActivity.class);
                    intent.putExtra("url",Constant.REQUEST);
                    intent.putExtra("title",getString(R.string.request_books));
                    startActivity(intent);
                    break;
                case R.id.menu_contact:
                    intent = new Intent(getApplicationContext(),LoadUrlActivity.class);
                    intent.putExtra("url",Constant.CONTACTURL);
                ...
                case R.id.menu_home:
                    ...
                    //MainActivity.shopClicked = false;
                ...
                case R.id.menu_share:
                    ...
                    shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.sharedesc)+"\n"+ Constant.PLAY_STORE_LINK + getPackageName());
