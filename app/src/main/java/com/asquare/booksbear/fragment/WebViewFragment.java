...
public class WebViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (type.equals("Sell")){
            mWebView.loadUrl(Constant.SELL);

        }
        else if (type.equals("Rent")){
            mWebView.loadUrl(Constant.RENT);

        }
        else if (type.equals("Ebooks")){
            mWebView.loadUrl(Constant.EBOOKS);

        }
        else if (type.equals("Donate")){
            mWebView.loadUrl(Constant.DONATE);

        }
        else if (type.equals("Request")){
            mWebView.loadUrl(Constant.REQUEST);
        }
        else {
            try {
