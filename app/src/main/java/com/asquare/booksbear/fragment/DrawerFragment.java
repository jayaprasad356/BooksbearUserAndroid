...
public class DrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvDonate = root.findViewById(R.id.menu_donate);
        tvRequest = root.findViewById(R.id.menu_request);
    ...
    public void OpenBottomDialog(final Activity activity) {
        try {
            ...
            EditText edtOldPassword = sheetView.findViewById(R.id.edtoldpsw);
            EditText edtNewPassword = sheetView.findViewById(R.id.edtnewpsw);
            EditText edtConfirmNewPassword = sheetView.findViewById(R.id.edtcnewpsw);
            ImageView imgChangePasswordClose = sheetView.findViewById(R.id.imgChangePasswordClose);
            Button btnChangePassword = sheetView.findViewById(R.id.btnchangepsw);
