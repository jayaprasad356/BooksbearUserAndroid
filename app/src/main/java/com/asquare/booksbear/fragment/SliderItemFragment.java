...
public class SliderItemFragment extends Fragment {
    ...
    @StringRes
    private static final int[] PAGE_TITLES = new int[]{R.string.empty,R.string.empty, R.string.empty,R.string.empty,R.string.empty};

    // prepare all subtitle ids arrays
    @StringRes
    private static final int[] PAGE_TEXT = new int[]{R.string.empty, R.string.empty, R.string.empty,R.string.empty,R.string.empty};
    // prepare all subtitle images arrays
    @StringRes
    private static final int[] PAGE_IMAGE = new int[]{R.drawable.intro_a, R.drawable.intro_b, R.drawable.intro_c,R.drawable.intro_d,R.drawable.intro_e};

    // prepare all background images arrays
    @StringRes
    private static final int[] BG_IMAGE = new int[]{R.color.white, R.color.white, R.color.white,R.color.white,R.color.white};
